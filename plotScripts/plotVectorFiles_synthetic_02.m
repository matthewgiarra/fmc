...
% RPC IID Gradient
paths{1} = '/Users/matthewgiarra/Documents/School/VT/Research/Aether/FMISPOMF/analysis/data/synthetic/vortex/lambvortex_2014-05-22_centralDifference/c_0.0250/lambvortex_h1024_w1024_00001/vect/rpc_deform/128x128/cstep_05/lambvortex_h1024_w1024_rpc_deform_grid32x32_region128x128_000010_000015.mat';

% FMC DWO Gradient
paths{2} = '/Users/matthewgiarra/Documents/School/VT/Research/Aether/FMISPOMF/analysis/data/synthetic/vortex/lambvortex_2014-05-22_centralDifference/c_0.0250/lambvortex_h1024_w1024_00001/vect/fmc/128x128/cstep_05/lambvortex_h1024_w1024_fmc_grid32x32_region128x128_000010_000015.mat';

% FMC DWO Direct
paths{3} = paths{2};

% FMC IID Gradient
paths{4} = '/Users/matthewgiarra/Documents/School/VT/Research/Aether/FMISPOMF/analysis/data/synthetic/vortex/lambvortex_2014-05-22_centralDifference/c_0.0250/lambvortex_h1024_w1024_00001/vect/fmc_deform/128x128/cstep_05/lambvortex_h1024_w1024_fmc_deform_grid32x32_region128x128_000010_000015.mat';
...
ha = tight_subplot(2, 2, [gap_h, gap_w], [marg_lower, marg_upper], [marg_left, marg_right]);

% Vorticity methods
kinds = {'grad', 'grad', 'dir', 'grad'};
...
xpos = [0.1 ; 0.1 + g; 0.1; 0.1 + g];
ypos = [0.5; 0.5; 0.09; 0.09];
