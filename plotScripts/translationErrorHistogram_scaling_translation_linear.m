...
function translationErrorHistogram_scaling_translation_linear(JOBLIST)
...
contourf( scalingBinEdges(1:end), translationBinEdges(1:end), meanAbsErrorTranslation(1:end, 1:end), contourLevels); 
...
% Save the figure
print(1, '-depsc', ['~/Desktop/Histograms/eps/translationError_scaling_translation_hist_' caseName '_' num2str(regionHeight) 'x' num2str(regionWidth) '_' JOBFILE.CorrelationType '_linear.eps']);
saveas(f, ['~/Desktop/Histograms/fig/translationError_scaling_translation_hist_' caseName '_' num2str(regionHeight) 'x' num2str(regionWidth) '_' JOBFILE.CorrelationType '_linear.fig']);
...
save(['~/Desktop/Histograms/data/translationError_scaling_translation_hist_' caseName...
    ...
    '_' JOBFILE.CorrelationType '_linear.mat'], 'JOBFILE', 'logAbsErrTranslation', 'scalingBinEdges', 'translationBinEdges', 'caseName', 'contourLevels', 'regionHeight', 'regionWidth', 'fSize');
