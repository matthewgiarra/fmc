START_DIR = /home/voodoo/Desktop/branch_fastLogPolar

MATLAB_ROOT = /usr/local/MATLAB/R2013a
MAKEFILE = transformationResiduals_mex.mk

include transformationResiduals_mex.mki


SRC_FILES =  \
	transformationResiduals_mexutil.c \
	transformationResiduals_data.c \
...
MEX_FILE_NAME_WO_EXT = transformationResiduals_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/transformationResiduals"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/transformationResiduals/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/transformationResiduals/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/transformationResiduals/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
