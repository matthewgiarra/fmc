function fmiErrorAnalysisMonteCarlo_compiled(JOBFILE, SAVEPATH, IMAGEFILEPATH, NDIGITS, PARAMETERSPATH, SPATIALWINDOW, IMAGESPECTRALFILTER, CONSTANTS, NPROCESSORS)
...
%         [estimatedTranslationY(k), estimatedTranslationX(k),...
%         estimatedRotation(k), estimatedScaling(k)] = ...
%         FMC_fast(IMAGE1, IMAGE2, SPATIALWINDOW, IMAGESPECTRALFILTER,...
%         fmiWindow, fmiSpectralFilter, ...
%         xImage, yImage, ...
%         resampledSourceX, resampledSourceY,...
%         xLP, yLP, rMin, rMax );   
