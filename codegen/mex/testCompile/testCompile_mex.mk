START_DIR = /Users/matthewgiarra/Documents/School/VT/Research/Aether/FMISPOMF/analysis/src/FMC/branch_fastLogPolar

MATLAB_ROOT = /Applications/MATLAB_R2013a.app
MAKEFILE = testCompile_mex.mk

include testCompile_mex.mki
...
MEX_FILE_NAME_WO_EXT = testCompile_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/testCompile"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/testCompile/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/testCompile/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/testCompile/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
