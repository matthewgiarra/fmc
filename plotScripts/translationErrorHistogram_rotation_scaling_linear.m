...
function translationErrorHistogram_rotation_scaling_linear(JOBLIST)
...
contourf( rotBinEdges(1:end-1), scalingBinEdges(1:end-1), meanAbsErrorTranslation(1:end-1, 1:end-1), contourLevels); 
