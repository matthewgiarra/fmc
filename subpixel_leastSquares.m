function [v, u, M, D] = subpixel_leastSquares(SPATIALCORRELATION, W, Peakswitch, METHOD)
...
%         method=Method;
        ...
        if shift_locx == 1
            ...
            shift_errx =  SPATIALCORRELATION( shift_locy , shift_locx+1 )/M(i); 
%             method=1;
...
%             method=1;
        ...
        if shift_locy == 1
            %boundary condition 1
            shift_erry = -SPATIALCORRELATION( shift_locy+1 , shift_locx )/M(i);
%             method=1;
