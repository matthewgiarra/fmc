...
function translationErrorHistogram_rotation_translation_linear(JOBLIST)
...
% Contour levels
contourLevels = 0 : 0.1 : 2;

% Absolute error of translation
f = figure(1);
contourf( rotBinEdges(1:end-1), translationBinEdges(1:end-1), meanAbsErrorTranslation(1:end-1, 1:end-1), contourLevels); 
...
% Save the figure
print(1, '-depsc', ['~/Desktop/Histograms/eps/translationError_rotation_translation_hist_' caseName '_' num2str(regionHeight) 'x' num2str(regionWidth) '_' JOBFILE.CorrelationType '_linear.eps']);
saveas(f, ['~/Desktop/Histograms/fig/translationError_rotation_translation_hist_' caseName '_' num2str(regionHeight) 'x' num2str(regionWidth) '_' JOBFILE.CorrelationType '_linear.fig']);
...
save(['~/Desktop/Histograms/data/translationError_rotation_translation_hist_' caseName...
    ...
    '_' JOBFILE.CorrelationType '_linear.mat'], 'JOBFILE', 'logAbsErrTranslation', 'translationBinEdges', 'rotBinEdges', 'caseName', 'contourLevels', 'regionHeight', 'regionWidth', 'fSize');
